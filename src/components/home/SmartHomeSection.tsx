...
import appPhoneDashboard from "@/assets/app-phone-dashboard.jpg";
import appTabletControls from "@/assets/app-tablet-controls.jpg";
import appTabletEnergy from "@/assets/app-tablet-energy.jpg";
